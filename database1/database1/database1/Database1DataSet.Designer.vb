...
Partial Public Class Database1DataSet
    ...
    Partial Public Class StudentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddStudentRow(ByVal firstname As String, ByVal lastname As String, ByVal gpa As Single, ByVal province As String, ByVal major As String) As StudentRow
            Dim rowStudentRow As StudentRow = CType(Me.NewRow,StudentRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, firstname, lastname, gpa, province, major}
    ...
    Partial Public Class StudentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE ((`ID` = ?) AND ((? = 1 AND `firstname` IS NULL) OR ("& _ 
                ...
                "(? = 1 AND `gpa` IS NULL) OR (`gpa` = ?)) AND ((? = 1 AND `province` IS NULL) OR"& _ 
                " (`province` = ?)) AND ((? = 1 AND `major` IS NULL) OR (`major` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Student` (`firstname`, `lastname`, `gpa`, `province`, `major`) VALUE"& _ 
                "S (?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Student` SET `firstname` = ?, `lastname` = ?, `gpa` = ?, `province` = ?, "& _ 
                "`major` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `firstname` IS NULL) OR (`firstnam"& _ 
                "e` = ?)) AND ((? = 1 AND `lastname` IS NULL) OR (`lastname` = ?)) AND ((? = 1 AN"& _ 
                "D `gpa` IS NULL) OR (`gpa` = ?)) AND ((? = 1 AND `province` IS NULL) OR (`provin"& _ 
                "ce` = ?)) AND ((? = 1 AND `major` IS NULL) OR (`major` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.database1.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, firstname, lastname, gpa, province, major FROM Student"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_firstname As String, ByVal Original_lastname As String, ByVal Original_gpa As Global.System.Nullable(Of Single), ByVal Original_province As String, ByVal Original_major As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal firstname As String, ByVal lastname As String, ByVal gpa As Global.System.Nullable(Of Single), ByVal province As String, ByVal major As String) As Integer
            ...
            If (gpa.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(gpa.Value,Single)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal firstname As String, ByVal lastname As String, ByVal gpa As Global.System.Nullable(Of Single), ByVal province As String, ByVal major As String, ByVal Original_ID As Integer, ByVal Original_firstname As String, ByVal Original_lastname As String, ByVal Original_gpa As Global.System.Nullable(Of Single), ByVal Original_province As String, ByVal Original_major As String) As Integer
            If (firstname Is Nothing) Then
            ...
            End If
            If (gpa.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(gpa.Value,Single)
            Else
            ...
            If (Original_gpa.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_gpa.Value,Single)
            Else
